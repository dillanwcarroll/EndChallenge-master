...
namespace WebApplication.Controllers
{
    public class TreatmentsController : Controller
    {
        ...
        {
            var treatments = db.Treatments.Include(t => t.Owner).Include(t => t.Procedure);
        ...
        public ActionResult Create([Bind(Include = "TreatmentID,PetName,OwnerID,ProcedureID,Date,Notes,Price")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TreatmentID,PetName,OwnerID,ProcedureID,Date,Notes,Price")] Treatment treatment)
        {
            if (ModelState.IsValid)
            {
